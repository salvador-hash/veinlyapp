...
import { Droplet, ArrowLeft, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <h1 className="text-4xl font-extrabold text-foreground mb-3">{t('privacyTitle')}</h1>
          <p className="text-muted-foreground">{t('privacyLastUpdated')}</p>
        </motion.div>
        ...
        <div className="text-center mt-12 text-sm text-muted-foreground">
          <p>{t('privacyContact')}: blooddonation854@gmail.com</p>
        </div>
      </div>
    </div>
  );
